    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="modifySuppAction.php" method="post">
                    <div class="form-group">
                        <label for="suppId">Supplier ID</label>
                        <input type="text" class="form-control" id="suppId" name="suppId" placeholder="Enter supplier's ID that you want edited">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="suppPrice">Total Price</label>
